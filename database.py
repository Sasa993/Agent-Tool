...
def testic():
	...
	# c.execute("UPDATE kategorija SET naziv_kategorije='Discrepancy' WHERE id_kategorije=16")
	...
	# 			rezultat = 15
	# 		elif ("Discrepancy" in glavniString) or ("different amount" in glavniString):
	# 			rezultat = 16
	# 		else:
	# 			rezultat = 17
