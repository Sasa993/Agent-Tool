...
def testic():
	...
	# c.execute("CREATE TABLE shifts (id_shifts INTEGER PRIMARY KEY, shift_ends TEXT, shift_last_changed DATE)")
	# c.execute("INSERT INTO shifts VALUES(NULL, strftime('%H:%M:%S', '06:00:00'), strftime('%m/%d/%Y', 'now'))")
